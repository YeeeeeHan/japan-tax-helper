...
6. **経費カテゴリ** (suggestedCategory): 国税庁公式経費科目から選択
   ...
   **標準カテゴリ**
   ...
   - 荷造運賃 (梱包、配送、宅配、郵送、送料など)
   - 水道光熱費 (電気、ガス、水道など)
   - 損害保険料 (損害保険、賠償責任保険、火災保険、自動車保険など)
...
export const CATEGORY_KEYWORDS = {
  ...
  荷造運賃: [
    '荷造', '運賃', '配送', '宅配', '郵送', 'ヤマト', 'クロネコ', '佐川',
    'YAMATO', 'SAGAWA', '日本郵便', 'ゆうパック', 'DHL', 'FedEx',
    '送料', '発送', '梱包', 'SHIPPING', '郵便', 'POST', 'レターパック'
  ],
  損害保険料: [
    '保険', 'INSURANCE', '損保', '火災保険', '自動車保険', '車両保険',
    '損害保険', '賠償責任保険', '傷害保険', '業務賠償保険', '地震保険'
  ],
  福利厚生費: [
